...
//   para percorrer toda a numeração.
for (let index = 0; index <= listadealunos; index++) {
//  SE index for igual (==) a zero, imprimirá: "Número é zero".
  if (index == 0) 
   {
    console.log(index + ` : Número zero`);
// E SE o resto da divisão (%), do index, por 2, for igual (==) a zero, imprimirá: "Número par".
   } else if  (index % 2 === 0){
